...
def build_analysis_prompt(
    ...
    return "\n".join(
        [
            ...
            "Every meeting_script bubble must be a complete natural Korean spoken sentence, roughly 16-70 characters; never return a heading-like fragment such as '최종 판단' or '확정 보류'.",
